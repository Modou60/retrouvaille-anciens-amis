...
$utilisateurs->setCivilite('la civilité')->setNom('Ndao')->setPrenom('Modou')->setDateNaiss($date)->setAdresse('mon adresse')->setCodePostal('mon code postal')->setVille('ma ville')->setPays('mon pays')->setTelephone('mon téléphone')->setEmail('modou@free.fr')->setPeriode('ma période')->setLogin('mon login')->setPassword('mot de passe')->setConfirmepassword('confirmer mot de passe')->setSlug('slug')->setRoles([1])->addMessage($messages);
        ...
        $this->assertTrue($utilisateurs->getMessage() === $messages);
    }
...
->setNom('Ndao')->setPrenom('Modou')->setDateNaiss($date)->setAdresse('mon adresse')->setCodePostal('mon code postal')->setVille('ma ville')->setPays('mon pays')->setTelephone('mon téléphone')->setEmail('modou@free.fr')->setPeriode('ma période')->setLogin('mon login')->setPassword('mot de passe')->setConfirmepassword('confirmer mot de passe')->setSlug('slug')->setRoles([1])->addMessage($messages);
        ...
        $this->assertFalse($utilisateurs->getMessage() !== $messages);
    }
